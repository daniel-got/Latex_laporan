...
\begin{document}
    ...
    \title{Analisis Komparatif Kinerja Model Machine Learning, Deep Learning, dan Transformer (BERT/DistilBERT) untuk Klasifikasi Otomatis Kebutuhan Perangkat Lunak Fungsional dan Non-Fungsional dalam Bahasa Indonesia.}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Comparative Analysis of Machine Learning, Deep Learning, and Transformer (BERT/DistilBERT) Model Performance for Automatic Classification of Functional and Non-Functional Software Requirements in Indonesian.}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{Daniel Calvin Simanjuntak}		% Nama Mahasiswa
	\nim{123140004}				% NIM Mahasiswa

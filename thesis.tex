...
\begin{document}
    ...
    % Judul Tugas Akhir, dalam Bahasa Indonesia	
	   \title{Komparasi SVM, Bi-LSTM, dan DistilBERT untuk Klasifikasi Otomatis Kebutuhan Perangkat Lunak Fungsional dan Non-Fungsional Indonesia}
	   % Judul Tugas Akhir dalam Bahasa Inggris
	   \titleEN{Comparing SVM, Bi-LSTM, and DistilBERT for Automatic Classification of Indonesian Functional and Non-Functional Requirements}
